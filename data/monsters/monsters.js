...
monsterAbilities = groupBy(monsterAbilities, "game");
for (let key of Object.keys(monsterAbilities)) {
  monsterAbilities[key] = groupBy(monsterAbilities[key], "name");
}

let fs = require("fs");

monsters = monsters
  .filter((m) => m.image.endsWith("-4.png") || m.image.endsWith("-6.png"))
  .map((monster) => {
    let game = "";
    switch (monster.expansion) {
      case "Gloomhaven":
        game = "gh";
        break;
      case "Forgotten Circles":
    ...
    if (monster.image.endsWith("-4.png")) {
      ...
      statCards = [
        monster.image.replace("-6.png", "-0.png"),
        monster.image.replace("-6.png", "-2.png"),
        monster.image.replace("-6.png", "-4.png"),
        monster.image,
      ];
    }
